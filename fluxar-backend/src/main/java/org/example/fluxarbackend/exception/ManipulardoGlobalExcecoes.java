...
@ControllerAdvice
public class ManipulardoGlobalExcecoes extends RuntimeException {

    @ExceptionHandler(CargoInexistenteException.class)
    public ResponseEntity<String> HandlerCargoInexistenteException(
            final CargoInexistenteException exception
    ){
